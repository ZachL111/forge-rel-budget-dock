"""Regression checks for the forge-rel-budget-dock casebook."""
...
from casebook.harness import assert_expected, forge_rel_budget_dock_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(forge_rel_budget_dock_summary(), assert_expected())
